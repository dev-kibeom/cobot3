...
SUPABASE_URL = "https://gppsbxlvbgfmcchjqrwu.supabase.co"   # 여기에 입력
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdwcHNieGx2YmdmbWNjaGpxcnd1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzkzMzczNjgsImV4cCI6MjA5NDkxMzM2OH0.7cAlleV_j8HE9_oHq8MmCoQu141H6qutd2FV5BY_vQo"        # 여기에 입력
