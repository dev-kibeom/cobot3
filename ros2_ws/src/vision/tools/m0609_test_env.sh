...
alias vtop_once='ros2 launch vision m0609_topview_pipeline.launch.py image_topic:=/camera/rgb/observer_01/compressed image_transport:=compressed trigger_topic:=/m0609/vision/capture_request'
...
alias vtrigger='ros2 topic pub --once /m0609/vision/capture_request std_msgs/msg/Empty "{}"'
...
echo "Aliases: vyolo, vbrain, vtop, vtop_once, vtrigger, vgateway103, vmotiongoal, vrqt, vgoal, vimg, vdebug, vdebugc"
